...
<x-layout>
    ...
    >
        ...
        <form
            method="POST"
            action="{{route('jobs.update', $job->id)}}" enctype="multipart/form-data"    >
            @csrf
            @method('PUT')
            ...
            <x-inputs.text-area id="description" name="description" label="Description" rows="7"
            ...
            <x-inputs.text-area id="requirements" name="requirements" label="Requirements" row="3"
                                placeholder="Bachelor's degree in Computer Science"
                                :value="old('requirements',$job->requirements)"
            />

            <x-inputs.text-area id="benefits" name="benefits" label="Benefits" row="3"
            ...
            <x-inputs.select id="job_type" name="job_type" label="Job Type" value="{{old('job_type',$job->job_type)}}"
                  ...
                  'Temporary'=>'Temporary', 'Intership'=>'Intership', 'Volunteer'=>'Volunteer', 'On-Call'=>'On-Call']"/>
            ...
            <x-inputs.text id="company_description" name="company_description" label="Company Description" placeholder="Company Description"  :value="old('company_description',$job->company_description)" />
            ...
            <x-inputs.text id="contact_phone" name="contact_phone" label="Company Phone" placeholder="Enter Phone"  :value="old('contact_phone',$job->contact_phone)"/>
