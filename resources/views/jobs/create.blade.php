...
<x-layout>
    ...
    <form
        method="POST"
        action="{{route('jobs.store')}}" enctype="multipart/form-data"    >
        @csrf
        <h2
 ...
 <x-inputs.text-area id="description" name="description" label="Description" rows="7"
       ...
       :options="['Full-Time'=>'Full-Time','Part-Time'=>'Part-Time', 'Contract'=>'Contract',
        ...
        <x-inputs.text id="company_description" name="company_description" label="Company Description" placeholder="Company Description" />

        <x-inputs.text id="company_website" name="company_website" type="url" label="Company Website" placeholder="Enter website" />

        <x-inputs.text id="contact_phone" name="contact_phone" label="Company Phone" placeholder="Enter Phone" />
